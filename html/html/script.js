...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const menuImages = {
        classique: "assets/img/tenders.png",
        epice: "assets/img/tenders piquant.png",
        famille: "assets/img/bucket.png",
        gus: "assets/img/signature.png",
        vegan: "assets/img/vegan.png"
    };

    menuCards.forEach(card => {
        const menuKey = card.getAttribute('data-menu');
        const image = card.querySelector('.menu-image');
        image.src = menuImages[menuKey];
    });
